...
def genNewTop():
    ...
    # Label(, text = "jjj").place(0,0)
    # top.iconbitmap("C:\\Users\\DucPhan\\Downloads\\ico.ico") # transparent empty icon to hide the default icon
    return top
...
class Snake:
    def reset(self):
        ...
        # self.appleTop.geometry('100x200')
